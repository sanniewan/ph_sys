...
class AtlasEzoPeristalticPump:
    """Class for the peristaltic pump for changing the address and dispensing volume"""
...
def main() -> None:
    ...
    pump = AtlasEzoPeristalticPump(current_address)
    time.sleep(1)
    volume_to_disp = 15
