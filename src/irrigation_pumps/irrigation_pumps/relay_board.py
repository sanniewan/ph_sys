...
class MCP23017_RelayBoard:
    ...
    def close(self, port: int) -> tuple[bool, str, bool]:
        ...
        if err:
            return True, f'Unable to execute close() relay at port {port}' + message, False
        
        return False, '', True

    def open(self, port: int) -> tuple[bool, str, bool]:
        ...
        if err:
            return True, f'Unable to execute open() relay at port {port}' + message, True
