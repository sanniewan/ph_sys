...
#include "interfaces/srv/detail/peristaltic_pump_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::PeristalticPumpService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::PeristalticPumpService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::PeristalticPumpService_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PeristalticPumpService_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::srv::PeristalticPumpService_Request *>(
...
static size_t _PeristalticPumpService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PeristalticPumpService_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PeristalticPumpService_Request__callbacks = {
  "interfaces::srv",
...
static rosidl_message_type_support_t _PeristalticPumpService_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PeristalticPumpService_Request__callbacks,
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_PeristalticPumpService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::PeristalticPumpService_Response;
    is_plain =
      (
      offsetof(DataType, volume) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const interfaces::srv::PeristalticPumpService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::PeristalticPumpService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PeristalticPumpService_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::srv::PeristalticPumpService_Response *>(
...
static size_t _PeristalticPumpService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PeristalticPumpService_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PeristalticPumpService_Response__callbacks = {
  "interfaces::srv",
...
static rosidl_message_type_support_t _PeristalticPumpService_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PeristalticPumpService_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_PeristalticPumpService_Response__handle;
}
...
static service_type_support_callbacks_t _PeristalticPumpService__callbacks = {
  "interfaces::srv",
...
static rosidl_service_type_support_t _PeristalticPumpService__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PeristalticPumpService__callbacks,
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_PeristalticPumpService__handle;
}
