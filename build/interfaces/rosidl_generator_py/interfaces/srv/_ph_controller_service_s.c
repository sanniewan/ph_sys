...
bool interfaces__srv__ph_controller_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.srv._ph_controller_service.PhControllerService_Request", full_classname_dest, 65) == 0);
  }
  interfaces__srv__PhControllerService_Request * ros_message = _ros_message;
  {  // ph
...
{
  /* NOTE(esteve): Call constructor of PhControllerService_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._ph_controller_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PhControllerService_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool interfaces__srv__ph_controller_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
...
{
  /* NOTE(esteve): Call constructor of PhControllerService_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._ph_controller_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PhControllerService_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
