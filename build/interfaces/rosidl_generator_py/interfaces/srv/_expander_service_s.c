...
bool interfaces__srv__expander_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.srv._expander_service.ExpanderService_Request", full_classname_dest, 56) == 0);
  }
  interfaces__srv__ExpanderService_Request * ros_message = _ros_message;
  {  // sender
...
{
  /* NOTE(esteve): Call constructor of ExpanderService_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._expander_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExpanderService_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool interfaces__srv__expander_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.srv._expander_service.ExpanderService_Response", full_classname_dest, 57) == 0);
  }
  interfaces__srv__ExpanderService_Response * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of ExpanderService_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._expander_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExpanderService_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
