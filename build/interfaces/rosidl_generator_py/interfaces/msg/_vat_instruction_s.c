...
bool interfaces__msg__vat_instruction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._vat_instruction.VatInstruction", full_classname_dest, 46) == 0);
  }
  interfaces__msg__VatInstruction * ros_message = _ros_message;
  {  // instruction
...
{
  /* NOTE(esteve): Call constructor of VatInstruction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._vat_instruction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VatInstruction");
