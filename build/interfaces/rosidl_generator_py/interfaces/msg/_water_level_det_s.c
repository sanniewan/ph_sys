...
bool interfaces__msg__water_level_det__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._water_level_det.WaterLevelDet", full_classname_dest, 45) == 0);
  }
  interfaces__msg__WaterLevelDet * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of WaterLevelDet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._water_level_det");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WaterLevelDet");
