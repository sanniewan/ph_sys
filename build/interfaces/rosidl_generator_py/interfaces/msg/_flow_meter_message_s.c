...
bool interfaces__msg__flow_meter_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._flow_meter_message.FlowMeterMessage", full_classname_dest, 51) == 0);
  }
  interfaces__msg__FlowMeterMessage * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of FlowMeterMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._flow_meter_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FlowMeterMessage");
