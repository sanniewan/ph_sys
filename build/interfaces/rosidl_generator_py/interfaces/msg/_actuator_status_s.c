...
bool interfaces__msg__actuator_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._actuator_status.ActuatorStatus", full_classname_dest, 46) == 0);
  }
  interfaces__msg__ActuatorStatus * ros_message = _ros_message;
  {  // err
...
PyObject * interfaces__msg__actuator_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._actuator_status");
