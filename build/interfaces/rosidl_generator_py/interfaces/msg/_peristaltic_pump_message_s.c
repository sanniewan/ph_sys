...
bool interfaces__msg__peristaltic_pump_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._peristaltic_pump_message.PeristalticPumpMessage", full_classname_dest, 63) == 0);
  }
  interfaces__msg__PeristalticPumpMessage * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of PeristalticPumpMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._peristaltic_pump_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PeristalticPumpMessage");
