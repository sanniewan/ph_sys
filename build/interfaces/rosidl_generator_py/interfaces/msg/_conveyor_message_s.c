...
bool interfaces__msg__conveyor_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._conveyor_message.ConveyorMessage", full_classname_dest, 48) == 0);
  }
  interfaces__msg__ConveyorMessage * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of ConveyorMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._conveyor_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConveyorMessage");
