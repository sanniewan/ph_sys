...
bool interfaces__msg__ph_controller_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._ph_controller_message.PhControllerMessage", full_classname_dest, 57) == 0);
  }
  interfaces__msg__PhControllerMessage * ros_message = _ros_message;
  {  // pump_id
...
{
  /* NOTE(esteve): Call constructor of PhControllerMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._ph_controller_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PhControllerMessage");
