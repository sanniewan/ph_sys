...
bool interfaces__msg__air_sensor_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._air_sensor_message.AirSensorMessage", full_classname_dest, 51) == 0);
  }
  interfaces__msg__AirSensorMessage * ros_message = _ros_message;
  {  // err
...
{
  /* NOTE(esteve): Call constructor of AirSensorMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._air_sensor_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AirSensorMessage");
